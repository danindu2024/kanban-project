...
*Why separate collection? To allow massive scaling of columns without hitting BSON document limits on the Board.*
| Field | Type | Description |
| :--- | :--- | :--- |
| `_id` | ObjectId | Unique Identifier |
...
## 3. API Contract (REST)
All responses will follow a standard envelope:
```json
{
  "success": true,
  "data": { ... },
